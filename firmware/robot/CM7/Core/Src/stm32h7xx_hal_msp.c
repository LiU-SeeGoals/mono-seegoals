...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PF11     ------> ADC1_INP2
    */
    GPIO_InitStruct.Pin = IR_OUT_ADC1_INP2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(IR_OUT_ADC1_INP2_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PF11     ------> ADC1_INP2
    */
    HAL_GPIO_DeInit(IR_OUT_ADC1_INP2_GPIO_Port, IR_OUT_ADC1_INP2_Pin);
...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  */
    ...
    PF9     ------> SPI5_MOSI
    */
    GPIO_InitStruct.Pin = KICKER_SPI5_SCK_Pin|KICKER_SPI5_MISO_Pin|KICKER_SPI5_MOSI_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI5_MspDeInit 0 */
    ...
    PF9     ------> SPI5_MOSI
    */
    HAL_GPIO_DeInit(GPIOF, KICKER_SPI5_SCK_Pin|KICKER_SPI5_MISO_Pin|KICKER_SPI5_MOSI_Pin);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  /* USER CODE END TIM1_MspPostInit 0 */
    ...
    PE14     ------> TIM1_CH4
    */
    GPIO_InitStruct.Pin = MOTOR1_PWM_Pin|MOTOR2_PWME11_Pin|MOTOR3_PWM_Pin|MOTOR4_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
