...
static void MX_GPIO_Init(void)
{
    ...
    HAL_GPIO_WritePin(GPIOE, MOTOR4_BREAK_Pin | MOTOR2_REVERSE_Pin | MOTOR2_BREAK_Pin | MOTOR3_REVERSE_Pin | MOTOR2_REVERSEE8_Pin | KICKER_CS_Pin | MOTOR4_REVERSE_Pin, GPIO_PIN_RESET);

    /*Configure GPIO pin Output Level */
    HAL_GPIO_WritePin(GPIOA, IMU_CS_Pin | IMU_INT1_Pin | IMU_INT2_Pin | IR_IN_Pin | IR_OUT_Pin, GPIO_PIN_RESET);

    /*Configure GPIO pin Output Level */
    HAL_GPIO_WritePin(GPIOB, LED_GREEN_Pin | MOTOR1_BREAK_Pin | KICKER_CHARGE_Pin | KICKER_ERR_Pin | LED_RED_Pin | MOTOR1_REVERSE_Pin | NRF_CSN_Pin, GPIO_PIN_RESET);

    /*Configure GPIO pin Output Level */
    HAL_GPIO_WritePin(GPIOB, KICKER_DISCHARGE2_Pin | KICKER_DISCHARGE1_Pin, GPIO_PIN_SET);

    /*Configure GPIO pin Output Level */
    HAL_GPIO_WritePin(GPIOD, MOTOR3_BREAK_Pin | MOTOR2_BREAKD13_Pin | EXT_LED1_RED_Pin | EXT_LED4_BLUE_Pin | EXT_LED2_BLUE_Pin | DRIBBLER_Pin | EXT_LED3_WHITE_Pin | BUZZER_Pin, GPIO_PIN_RESET);
    ...
    GPIO_InitStruct.Pin = MOTOR4_BREAK_Pin | MOTOR2_REVERSE_Pin | MOTOR2_BREAK_Pin | MOTOR3_REVERSE_Pin | MOTOR2_REVERSEE8_Pin | KICKER_CS_Pin | MOTOR4_REVERSE_Pin | LED_YELLOW_Pin;
    ...
    /*Configure GPIO pins : BATT1_Pin BATT2_Pin BATT3_Pin BATT4_Pin
                             BATT5_Pin */
    GPIO_InitStruct.Pin = BATT1_Pin | BATT2_Pin | BATT3_Pin | BATT4_Pin | BATT5_Pin;
    ...
    /*Configure GPIO pins : IMU_CS_Pin IMU_INT1_Pin IMU_INT2_Pin IR_IN_Pin
                             IR_OUT_Pin */
    GPIO_InitStruct.Pin = IMU_CS_Pin | IMU_INT1_Pin | IMU_INT2_Pin | IR_IN_Pin | IR_OUT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    ...
    /*Configure GPIO pins : LED_GREEN_Pin MOTOR1_BREAK_Pin KICKER_DISCHARGE2_Pin KICKER_CHARGE_Pin
                             ...
                             NRF_CSN_Pin */
    GPIO_InitStruct.Pin = LED_GREEN_Pin | MOTOR1_BREAK_Pin | KICKER_DISCHARGE2_Pin | KICKER_CHARGE_Pin | KICKER_DISCHARGE1_Pin | KICKER_ERR_Pin | LED_RED_Pin | MOTOR1_REVERSE_Pin | NRF_CSN_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    ...
    GPIO_InitStruct.Pin = MOTOR3_BREAK_Pin | MOTOR2_BREAKD13_Pin | EXT_LED1_RED_Pin | EXT_LED4_BLUE_Pin | EXT_LED2_BLUE_Pin | DRIBBLER_Pin | EXT_LED3_WHITE_Pin | BUZZER_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
