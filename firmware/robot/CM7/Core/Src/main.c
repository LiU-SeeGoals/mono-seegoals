    ...
    while (1) {
        if (HAL_GetTick() - now > 1000) {
            if (on) {
                ...
                HAL_GPIO_WritePin(LIANG_TEST_GPIO_Port, LIANG_TEST_Pin, GPIO_PIN_RESET);
                NAV_StopDribbler();

            } else {
                HAL_GPIO_WritePin(LED_YELLOW_GPIO_Port, LED_YELLOW_Pin, GPIO_PIN_SET);
                HAL_GPIO_WritePin(BUZZER_GPIO_Port, BUZZER_Pin, GPIO_PIN_SET);
                HAL_GPIO_WritePin(LIANG_TEST_GPIO_Port, LIANG_TEST_Pin, GPIO_PIN_SET);
                NAV_RunDribbler();
            }
            on = !on;
            now = HAL_GetTick();
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, IMU_CS_Pin|IMU_INT1_Pin|IMU_INT2_Pin|LIANG_TEST_Pin
                          |IR_IN_Pin|IR_OUT_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : IMU_CS_Pin IMU_INT1_Pin IMU_INT2_Pin LIANG_TEST_Pin
                           IR_IN_Pin IR_OUT_Pin */
  GPIO_InitStruct.Pin = IMU_CS_Pin|IMU_INT1_Pin|IMU_INT2_Pin|LIANG_TEST_Pin
                          |IR_IN_Pin|IR_OUT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
