...
/* USER CODE END Boot_Mode_Sequence_2 */
  ...
  /* USER CODE BEGIN 2 */
    ...
    // Initialise modules
    LOG_Init(&huart3);
    LOG_InitModule(&internal_log_mod, "MAIN", LOG_LEVEL_TRACE, 0);
  ...
  /* USER CODE BEGIN WHILE */
    ...
    while (1) {
        ...
        uint32_t value = HAL_ADC_GetValue(&hadc1); // Get result
        int digval = HAL_GPIO_ReadPin(IR_TEST2_GPIO_Port, IR_TEST2_Pin);

        float voltage = (value / 4095.0f) * 3.3f;  // Convert to volts
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, IMU_CS_Pin|IMU_INT1_Pin|IMU_INT2_Pin|IR_ENABLE_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : IMU_CS_Pin IMU_INT1_Pin IMU_INT2_Pin IR_ENABLE_Pin */
  GPIO_InitStruct.Pin = IMU_CS_Pin|IMU_INT1_Pin|IMU_INT2_Pin|IR_ENABLE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pin : IR_TEST2_Pin */
  GPIO_InitStruct.Pin = IR_TEST2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(IR_TEST2_GPIO_Port, &GPIO_InitStruct);
