 ...
 */
void arm_mat_qr(const arm_matrix_instance_f32* pA, arm_matrix_instance_f32* pQ, arm_matrix_instance_f32* pR, arm_matrix_instance_f32* pH, arm_matrix_instance_f32* pTmp);
...
static inline float* arm_mat_row_ptr(const arm_matrix_instance_f32* pMat, uint16_t row) { return pMat->pData + pMat->numCols * row; }
