...
static inline Quat M4ToQ_RH(Mat4 M)
{
    ...
    if (M.Elements[2][2] < 0.0f) {
        if (M.Elements[0][0] > M.Elements[1][1]) {
            ...
            Qq = Q(T, M.Elements[0][1] + M.Elements[1][0], M.Elements[2][0] + M.Elements[0][2], M.Elements[1][2] - M.Elements[2][1]);
        } else {
            ASSERT_COVERED(M4ToQ_RH);

            T = 1 - M.Elements[0][0] + M.Elements[1][1] - M.Elements[2][2];
            Qq = Q(M.Elements[0][1] + M.Elements[1][0], T, M.Elements[1][2] + M.Elements[2][1], M.Elements[2][0] - M.Elements[0][2]);
        }
    } else {
        if (M.Elements[0][0] < -M.Elements[1][1]) {
            ASSERT_COVERED(M4ToQ_RH);
            ...
            T = 1 - M.Elements[0][0] - M.Elements[1][1] + M.Elements[2][2];
            Qq = Q(M.Elements[2][0] + M.Elements[0][2], M.Elements[1][2] + M.Elements[2][1], T, M.Elements[0][1] - M.Elements[1][0]);
        } else {
            ASSERT_COVERED(M4ToQ_RH);

            T = 1 + M.Elements[0][0] + M.Elements[1][1] + M.Elements[2][2];
            Qq = Q(M.Elements[1][2] - M.Elements[2][1], M.Elements[2][0] - M.Elements[0][2], M.Elements[0][1] - M.Elements[1][0], T);
        }
    }
...
static inline Quat M4ToQ_LH(Mat4 M)
{
    ...
    if (M.Elements[2][2] < 0.0f) {
        if (M.Elements[0][0] > M.Elements[1][1]) {
            ...
            T = 1 + M.Elements[0][0] - M.Elements[1][1] - M.Elements[2][2];
            Qq = Q(T, M.Elements[0][1] + M.Elements[1][0], M.Elements[2][0] + M.Elements[0][2], M.Elements[2][1] - M.Elements[1][2]);
        } else {
            ASSERT_COVERED(M4ToQ_LH);

            T = 1 - M.Elements[0][0] + M.Elements[1][1] - M.Elements[2][2];
            Qq = Q(M.Elements[0][1] + M.Elements[1][0], T, M.Elements[1][2] + M.Elements[2][1], M.Elements[0][2] - M.Elements[2][0]);
        }
    } else {
        if (M.Elements[0][0] < -M.Elements[1][1]) {
            ASSERT_COVERED(M4ToQ_LH);
            ...
            T = 1 - M.Elements[0][0] - M.Elements[1][1] + M.Elements[2][2];
            Qq = Q(M.Elements[2][0] + M.Elements[0][2], M.Elements[1][2] + M.Elements[2][1], T, M.Elements[1][0] - M.Elements[0][1]);
        } else {
            ASSERT_COVERED(M4ToQ_LH);

            T = 1 + M.Elements[0][0] + M.Elements[1][1] + M.Elements[2][2];
            Qq = Q(M.Elements[2][1] - M.Elements[1][2], M.Elements[0][2] - M.Elements[2][0], M.Elements[1][0] - M.Elements[0][2], T);
        }
    }
...
#define Add(A, B) _Generic((A), Vec2: AddV2, Vec3: AddV3, Vec4: AddV4, Mat2: AddM2, Mat3: AddM3, Mat4: AddM4, Quat: AddQ)(A, B)

#define Sub(A, B) _Generic((A), Vec2: SubV2, Vec3: SubV3, Vec4: SubV4, Mat2: SubM2, Mat3: SubM3, Mat4: SubM4, Quat: SubQ)(A, B)

#define Mul(A, B)                                                                                                                                                                                      \
    _Generic((B),                                                                                                                                                                                      \
        float: _Generic((A), Vec2: MulV2F, Vec3: MulV3F, Vec4: MulV4F, Mat2: MulM2F, Mat3: MulM3F, Mat4: MulM4F, Quat: MulQF),                                                                         \
        Mat2: MulM2,                                                                                                                                                                                   \
        Mat3: MulM3,                                                                                                                                                                                   \
        Mat4: MulM4,                                                                                                                                                                                   \
        Quat: MulQ,                                                                                                                                                                                    \
        default: _Generic((A), Vec2: MulV2, Vec3: MulV3, Vec4: MulV4, Mat2: MulM2V2, Mat3: MulM3V3, Mat4: MulM4V4))(A, B)

#define Div(A, B)                                                                                                                                                                                      \
    _Generic((B),                                                                                                                                                                                      \
        float: _Generic((A), Mat2: DivM2F, Mat3: DivM3F, Mat4: DivM4F, Vec2: DivV2F, Vec3: DivV3F, Vec4: DivV4F, Quat: DivQF),                                                                         \
        Mat2: DivM2,                                                                                                                                                                                   \
        Mat3: DivM3,                                                                                                                                                                                   \
        Mat4: DivM4,                                                                                                                                                                                   \
        Quat: DivQ,                                                                                                                                                                                    \
...
#define LenSqr(A) _Generic((A), Vec2: LenSqrV2, Vec3: LenSqrV3, Vec4: LenSqrV4)(A)
...
#define Lerp(A, T, B) _Generic((A), float: Lerp, Vec2: LerpV2, Vec3: LerpV3, Vec4: LerpV4)(A, T, B)

#define Eq(A, B) _Generic((A), Vec2: EqV2, Vec3: EqV3, Vec4: EqV4)(A, B)

#define Transpose(M) _Generic((M), Mat2: TransposeM2, Mat3: TransposeM3, Mat4: TransposeM4)(M)

#define Determinant(M) _Generic((M), Mat2: DeterminantM2, Mat3: DeterminantM3, Mat4: DeterminantM4)(M)

#define InvGeneral(M) _Generic((M), Mat2: InvGeneralM2, Mat3: InvGeneralM3, Mat4: InvGeneralM4)(M)
