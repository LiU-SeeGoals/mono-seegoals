...
export const SSLWrapperPacket = {
  ...
  fromJSON(object: any): SSLWrapperPacket {
    return {
      detection: isSet(object.detection)
        ? SSLDetectionFrame.fromJSON(object.detection)
        : undefined,
      geometry: isSet(object.geometry)
        ? SSLGeometryData.fromJSON(object.geometry)
        : undefined,
    };
  },
  ...
  create<I extends Exact<DeepPartial<SSLWrapperPacket>, I>>(
    base?: I
  ): SSLWrapperPacket {
    return SSLWrapperPacket.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<SSLWrapperPacket>, I>>(
    object: I
  ): SSLWrapperPacket {
    const message = createBaseSSLWrapperPacket();
    message.detection =
      object.detection !== undefined && object.detection !== null
